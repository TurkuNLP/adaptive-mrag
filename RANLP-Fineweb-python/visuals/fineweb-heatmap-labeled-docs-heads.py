...
def get_embeddings(text):
    ...
    return model.layers[-1].self_attn.o_proj.cached_heads, inputs.attention_mask  # (batch_size, seq_length, hidden_size) 
...
cosine_scores_raw = []
cosine_scores = []
output_path_base = "data/FineWeb-embedd-hook_output_10000/"
