...
This file checks if heads are linearly seperable using a multi-class logistic prob.
"""
...
X_train, X_test, y_train, y_test = train_test_split(X, y_shuffled, test_size=0.2, random_state=42, stratify=y_shuffled)
...
print("Stage1 Accuracy:", accuracy_score(y_test, y_pred))
